...
import nl.knmi.adaguc.services.esgfsearch.SessionManager.DatasetViewerSession;
    ...
    */
		...
		try{
			...
			if(authenticator != null){
				try {
					...
					Debug.println("No user information provided: " + e2.getMessage());
				}
      ...
      if(user!=null){
        if(user.getUserId()!=null){
          ...
          try {
            requestStrWithOpenId+="openid="+URLEncoder.encode(user.getUserId(),"utf-8");
