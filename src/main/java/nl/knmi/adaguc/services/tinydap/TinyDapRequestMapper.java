...
import nl.knmi.adaguc.usermanagement.User;
...
public class TinyDapRequestMapper {
	...
	@ResponseBody
	@RequestMapping("tinydap/opendap")
...
//	    }
	    ...
	    TinyDapServer.handleOpenDapReqeuests(localNetCDFFileName,baseName,request,response);
